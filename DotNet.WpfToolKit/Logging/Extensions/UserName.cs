...
namespace DotNet.WpfToolKit.Logging.Extensions;

public static class UserName
{
    public static LoggerConfiguration WithUserName(this LoggerEnrichmentConfiguration enrich)
    {
        return enrich == null ? throw new ArgumentNullException(nameof(enrich)) : enrich.With<Enrichers.UserNameEnricher>();
    }
}
